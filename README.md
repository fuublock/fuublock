...
FuyouToken is a lite version of Bitcoin using scrypt as a proof-of-work algorithm.
...
the FuyouToken client sofware, see http://www.FuyouToken.org.

License
-------

FuyouToken is released under the terms of the MIT license. See `COPYING` for more
